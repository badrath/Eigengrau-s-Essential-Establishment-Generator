...
describe(getAgeInYears.name, () => {
  it('returns a numerical age', () => {
    ...
    expect(typeof getAgeInYears('strix', 'settled adult')).toBe('number')
    expect(typeof getAgeInYears('merfolk', 'settled adult')).toBe('number')
    expect(typeof getAgeInYears('kobold', 'settled adult')).toBe('number')
    expect(typeof getAgeInYears('gnoll', 'settled adult')).toBe('number')
  })
})
