    ...
    get: {
      ...
      entertainment (tavern) {
        const entertainment = [
          ...
          `There is ${['a large human', 'an elf', 'a half-orc', 'a gnome', 'a dwarf', 'a dragonborn', 'a ratfolk', 'a kitsune', 'a strix', 'a merfolk', 'a kobold', 'a gnoll'].random()} in a puffy white hat up on ${lib.articles.output(tavern.stageDescriptor)} stage, giving some sort of cooking demonstration to the patrons.`,
